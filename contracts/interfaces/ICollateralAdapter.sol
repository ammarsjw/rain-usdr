...
interface ICollateralAdapter {
     ...
     *         {_USDR_ILK} marks the ilk as the USDR ilk (mint/burn behaviour).
     * @param ilkId Identifier of the ilk.
     ...
     * @dev Collateral ilks credit free collateral (the caller must have approved the adapter); the USDR ilk burns
     ...
     * @dev Collateral ilks release custodied tokens (the caller must have enough free collateral); the USDR ilk
