 ...
 * @author Rain Team
 * @notice Dedicated interface through which the prediction market layer (owned by a separate team) reports its
 *         exposure. The Solvency Engine consumes this figure as a number.
 */
