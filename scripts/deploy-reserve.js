...
const deployReserve = async () => {
    ...
    // Setting the prediction-market exposure cap BEFORE any reporter is wired ($250k launch cap): an unset
    // (zero) cap would clamp every report to zero, silently suppressing real exposure.
    await (
