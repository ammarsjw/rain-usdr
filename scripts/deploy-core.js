...
const { BURNER_ROLE, WARD_ROLE } = require("./helpers/shared/constants");
...
const deployCore = async () => {
    ...
    // Authorizing the adapter on the ledger, as a token minter, and as the only burner-from-any-address.
